...
<% if (session == null || session.getAttribute("user") == null) { %>
	<font color="red">You need to be logged in to view your account!</font><br>
...
<nav class="navbar navbar-inverse navbar-fixed-top">
   <div class="container-fluid">
     <div class="navbar-header">
       ...
       <a class="navbar-brand disabled">Butterfly Tracking System | Account | N.I.X.Y.</a>
     </div>
...
<form action="customtaggings" method="post" class="form-horizontal col-md-4">
	<div class="form-group">
	<label class="col-sm-5 control-label">Email</label>
    <div class="col-sm-7">
      <input class="form-control" placeholder="<%= user.getEmail() %>" disabled>
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-5 control-label">First Name</label>
    <div class="col-sm-7">
      <input class="form-control" placeholder="<%= user.getFirstName() %>" disabled>
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-5 control-label">Last Name</label>
    <div class="col-sm-7">
      <input class="form-control" placeholder="<%= user.getLastName() %>" disabled>
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-5 control-label">Street Address</label>
    <div class="col-sm-7">
      <input class="form-control" placeholder="<%= user.getAddress() %>" disabled>
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-5 control-label">City</label>
    <div class="col-sm-7">
      <input class="form-control" placeholder="<%= user.getUserCity() %>" disabled>
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-5 control-label">State</label>
    <div class="col-sm-7">
      <input class="form-control" placeholder="<%= user.getUserState() %>" disabled>
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-5 control-label">Zip Code</label>
    <div class="col-sm-7">
      <input class="form-control" placeholder="<%= user.getZipCode() %>" disabled>
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-5 control-label">Country</label>
    <div class="col-sm-7">
      <input class="form-control" placeholder="<%= user.getUserCountry() %>" disabled>
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-5 control-label">Phone Number</label>
    <div class="col-sm-7">
      <input class="form-control" placeholder="<%= user.getPhone() %>" disabled>
    </div>
  	</div>
  	
</form>
<form action="accountupdate" method="post" autocomplete="off" class="form-horizontal col-md-8">
<!-- Use this form to make changes to your account (only non-empty fields will be updated):  -->
	<div class="form-group">
    ...
    <div class="col-sm-4">
    <select class="form-control" name="country" autocomplete="off"  placeholder="Country" onchange="onSelect(this)">
    ...
    <div class="col-sm-4">
    <input type="text" class="form-control" name="zipCode" autocomplete="off" pattern=".{0}|.{5}" title="5 digit zip code"  placeholder="Zip Code"  >
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-2 control-label">Phone Number</label>
    <div class="col-sm-4">
    <input type="number" class="form-control" name="phone" autocomplete="off" pattern=".{0}|.{10}" title="10 digit phone number" placeholder="Phone Number"  >
    </div>
  	</div>
  	<div class="form-group">
