...
<nav class="navbar navbar-inverse navbar-fixed-top">
   <div class="container-fluid">
     <div class="navbar-header">
       ...
       <a class="navbar-brand disabled">Butterfly Tracking System | Register | N.I.X.Y.</a>
     </div>
...
<br>
<form action="register" method="post" autocomplete="off" class="form-horizontal col-md-8 col-md-offset-1">
<div class="form-group">
	<label class="col-sm-2 control-label">Email</label>
    <div class="col-sm-4">
    <input type="email" class="form-control" id="email1" name="email" autocomplete="off" placeholder="Email"  required maxlength="30">
    </div>
    <label class="col-sm-2 control-label">Reenter Email</label>
    <div class="col-sm-4">
    <input type="email" class="form-control" id="email2" name="email" autocomplete="off" placeholder="Email"  required maxlength="30">
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-2 control-label">Password</label>
    <div class="col-sm-4">
    <input type="password" class="form-control" id="pass1" name="password" autocomplete="off" pattern=".{0}|.{8,40}" title="minimum 8 characters" placeholder="Password"  required>
    </div>
    <label class="col-sm-2 control-label">ReenterPassword</label>
    <div class="col-sm-4">
    <input type="password" class="form-control" id="pass2" name="password2" autocomplete="off" pattern=".{0}|.{8,40}" title="minimum 8 characters" placeholder="Password"  required>
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-2 control-label">First Name</label>
    <div class="col-sm-4">
    <input type="text" class="form-control" name="firstName" autocomplete="off"  placeholder="FirstName"  required maxlength="30">
    </div>
    <label class="col-sm-2 control-label">Last Name</label>
    <div class="col-sm-4">
    <input type="text" class="form-control" name="lastName" autocomplete="off"  placeholder="LasttName"  required maxlength="30">
    </div>
  	</div>
  	<div class="form-group">
	<label class="col-sm-2 control-label">Street Address</label>
    <div class="col-sm-4">
    <input type="text" class="form-control" name="streetAddress" autocomplete="off"  placeholder="Street Address"  required maxlength="30">
    </div>
    <label class="col-sm-2 control-label">City</label>
    <div class="col-sm-4">
    <input type="text" class="form-control" name="city" autocomplete="off"  placeholder="City"  required maxlength="30">
    </div>
  	</div>
  	<div class="form-group">
    ...
    <div class="col-sm-4">
    <input type="number" class="form-control" name="phone" autocomplete="off" pattern=".{0}|.{10}" title="10 digit phone number" placeholder="Phone Number"  required>
    </div>
  	</div>
  	<div class="form-group">
